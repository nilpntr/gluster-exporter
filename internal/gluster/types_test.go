...
func TestVolumeListXMLUnmarshall(t *testing.T) {
	...
	dat, err := os.ReadFile(testXMLPath)

	if err != nil {
		t.Errorf("error reading testxml in Path: %v", testXMLPath)
	}
	volumeList, err := utils.DecodeXml[VolumeListXML](bytes.NewBuffer(dat))
	if err != nil {
		t.Fatal(err)
	}
...
func TestInfoUnmarshall(t *testing.T) {
	...
	glusterVolumeInfo, _ := utils.DecodeXml[VolumeInfoXML](bytes.NewBuffer(dat))
...
func TestPeerStatusXMLUnmarshall(t *testing.T) {
	...
	peerStatus, err := utils.DecodeXml[PeerStatusXML](bytes.NewBuffer(dat))
	if err != nil {
		t.Fatal(err)
	}
...
func TestVolumeStatusAllDetailXMLUnmarshall(t *testing.T) {
	...
	volumeStatus, err := utils.DecodeXml[VolumeStatusXML](bytes.NewBuffer(dat))
	if err != nil {
		t.Error(err)
	}
...
func TestVolumeProfileGvInfoCumulativeXMLUnmarshall(t *testing.T) {
	...
	profileVolumeCumulative, err := utils.DecodeXml[VolumeProfileXML](bytes.NewBuffer(dat))
	if err != nil {
		t.Fatal(err)
	}
...
func TestVolumeHealInfoXMLUnmarshall(t *testing.T) {
	...
	for _, c := range test {
		...
		healInfo, err := utils.DecodeXml[VolumeHealInfoXML](cmdOutBuffer)
		if err != nil {
			t.Error(err)
		}
...
func TestVolumeQuotaListXMLUnmarshall(t *testing.T) {
	...
	volumeQuotaXML, err := utils.DecodeXml[VolumeQuotaXML](bytes.NewBuffer(dat))
	if err != nil {
		t.Error(err)
	}
